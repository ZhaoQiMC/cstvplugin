 ...
 */
class CstvHotfixClassLoader extends CstvPluginClassLoader {
    private ClassLoader mChild = null;
    private Method findClassMethod = null;
    private Method findLoadedClassMethod = null;

    public CstvHotfixClassLoader(String dexPath, String dexOutputDir, String libPath,
                                 ClassLoader parent) {
    ...
    protected void setOrgAPKClassLoader(ClassLoader child) {
        mChild = child;
        findLoadedClassMethod = CstvPluginUtil.getMethod(mChild.getClass(), "findLoadedClass", String.class);
        findClassMethod = CstvPluginUtil.getMethod(mChild.getClass(), "findClass", String.class);
    }
