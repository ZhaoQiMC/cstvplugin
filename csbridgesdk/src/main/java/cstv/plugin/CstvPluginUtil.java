...
public class CstvPluginUtil {
    ...
    public static String getInsidePluginPath() {
        ...
        return mInsidePluginPath = CstvPluginManager.mBaseContext.getFilesDir().getPath() + "/plugins/";
    }
    ...
    public static String getAPKPath(String pluginName) {
        return CstvPluginUtil.getPlugDir(pluginName) + getInstalledPathInfo(pluginName) + CstvPluginConfig.PLUGIN_SUFF;
    }
    ...
    public static boolean iszeusPlugin(String pluginId) {
        return !TextUtils.isEmpty(pluginId) &&
                (pluginId.startsWith(CstvPluginConfig.EXP_PLUG_PREFIX) ||
                        isHotFix(pluginId));
    }
    ...
    public static boolean isPlugin(String pluginId) {
        return !TextUtils.isEmpty(pluginId) && pluginId.startsWith(CstvPluginConfig.EXP_PLUG_PREFIX);
    }
    ...
    public static boolean isPluginWithoutSoFile(String pluginId) {
        return !TextUtils.isEmpty(pluginId) && pluginId.startsWith(CstvPluginConfig.EXP_PLUG_NO_SO_PREFIX);
    }
    ...
    public static boolean isHotfixWithoutSoFile(String pluginId) {
        return !TextUtils.isEmpty(pluginId) &&
                (pluginId.startsWith(CstvPluginConfig.EXP_PLUG_HOT_FIX_NO_SO_PREFIX) ||
                        pluginId.startsWith(CstvPluginConfig.EXP_PLUG_HOT_FIX_NO_RES_SO_PREFIX));
    }
    ...
    public static boolean isHotfixWithoutResFile(String pluginId) {
        return !TextUtils.isEmpty(pluginId) &&
                (pluginId.startsWith(CstvPluginConfig.EXP_PLUG_HOT_FIX_NO_RES_PREFIX) ||
                        pluginId.startsWith(CstvPluginConfig.EXP_PLUG_HOT_FIX_NO_RES_SO_PREFIX));
    }
    ...
    public static boolean isHotfixWithoutSoAndResFile(String pluginId) {
        return !TextUtils.isEmpty(pluginId) && pluginId.startsWith(CstvPluginConfig.EXP_PLUG_HOT_FIX_NO_RES_SO_PREFIX);
    }
    ...
    public static boolean isHotFix(String pluginId) {
        return !TextUtils.isEmpty(pluginId) && pluginId.startsWith(CstvPluginConfig.EXP_PLUG_HOT_FIX_PREFIX);
    }
    ...
    public static String getPluginArchitecture() {
        String apkArch = CPUUtils.getAppAbi(CstvPluginManager.getAppContext());
        if(!TextUtils.isEmpty(apkArch)){
            return apkArch;
        }else {
            if(CPU_AMR == getCpuArchitecture()){
                if("64".equals(CPUUtils.checkAPKArc(CstvPluginManager.getAppContext()))){
                    return "arm64";
                }else{
                    return "armeabi";
                }
            }else if(CPU_X86 == getCpuArchitecture()){
                return "x86";
            }else if(CPU_MIPS == getCpuArchitecture()){
                return "mips";
            }
        }
        return null;
    ...
    public static boolean copyAssetsFile(String assetsFileName, String filePath){
        ...
        try {
            ...
            CstvPluginUtil.createDirWithFile(filePath);
    ...
    public static String getInstalledPathInfo(String pluginId) {
        String result = null;
        String libFileInfoPath = getPlugDir(pluginId) + CstvPluginConfig.PLUGIN_INSTALLED_INFO_PATH;
    ...
    public static boolean writePathInfo(String pluginId, String installedPathInfo) {
        String infoPath = CstvPluginUtil.getPlugDir(pluginId) + CstvPluginConfig.PLUGIN_INSTALLED_INFO_PATH;
