...
public class CstvHelper {
    ...
    public Object getSystemService(Context context, Object systemServcie, String name) {
        if (Context.LAYOUT_INFLATER_SERVICE.equals(name)) {
            ...
            //所以这里手动设置一次
            CstvPluginUtil.setField(inflater, "mContext", context);
            return inflater;
        }
    ...
    public static void attachBaseContext(Context newBase, Context context) {
        ...
        CstvPluginUtil.setField(newBase, "mOuterContext", context);
        //中兴手机是个奇葩，不知道它怎么实现的又重新生成了一个resources,这里得再次替换
        CstvPluginUtil.setField(newBase, "mResources", CstvPluginManager.mNowResources);
    }
    ...
    public Resources.Theme getTheme(Resources.Theme theme) {
        Resources localResources = CstvPluginManager.mNowResources;
    ...
    public static void onConfigurationChanged() {
        if (CstvPluginManager.mNowResources != null
                && CstvPluginManager.mBaseResources != null
                && CstvPluginManager.mNowResources != CstvPluginManager.mBaseResources) {
            CstvPluginManager.mNowResources.updateConfiguration(CstvPluginManager.mBaseResources.getConfiguration(),
                    CstvPluginManager.mBaseResources.getDisplayMetrics());
        }
    }
}
